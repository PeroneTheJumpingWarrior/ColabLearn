...
public class UploadNotes_InternetProt extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_upload_notes_internet_prot);
    ...
    public void selectPDFFile(){
        ...
        startActivityForResult(Intent.createChooser(intent, "Select Your PDF File"),2);
    }
    ...
    private void uploadPDFFile(Uri data) {
        ...
        StorageReference reference = storageReference.child("internetProtocols/"+System.currentTimeMillis()+".pdf");
        ...
        reference.putFile(data)
                .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        Toast.makeText(UploadNotes_InternetProt.this,"File Uploaded",Toast.LENGTH_SHORT).show();
