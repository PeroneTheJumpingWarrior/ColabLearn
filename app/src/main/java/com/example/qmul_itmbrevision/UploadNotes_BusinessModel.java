...
public class UploadNotes_BusinessModel extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_upload_notes_business_model);
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("businessModelling");
    ...
    public void selectPDFFile(){
        ...
        startActivityForResult(Intent.createChooser(intent, "Select Your PDF File"),4);
    }
    ...
    private void uploadPDFFile(Uri data) {
        ...
        StorageReference reference = storageReference.child("businessModelling/"+System.currentTimeMillis()+".pdf");
        ...
        reference.putFile(data)
                .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        Toast.makeText(UploadNotes_BusinessModel.this,"File Uploaded",Toast.LENGTH_SHORT).show();
