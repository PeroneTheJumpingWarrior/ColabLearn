...
public class UploadNotes_DatabaseSys extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_upload_notes_database_sys);
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("databaseSystems");
    ...
    public void selectPDFFile(){
        ...
        startActivityForResult(Intent.createChooser(intent, "Select Your PDF File"),3);
    }
    ...
    private void uploadPDFFile(Uri data) {
        ...
        StorageReference reference = storageReference.child("databaseSystems/"+System.currentTimeMillis()+".pdf");
        ...
        reference.putFile(data)
                .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        Toast.makeText(UploadNotes_DatabaseSys.this,"File Uploaded",Toast.LENGTH_SHORT).show();
